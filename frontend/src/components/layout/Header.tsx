...
export default function Header() {
  const { user, logout, toggleMobileMenu, isDarkMode, toggleDarkMode } = useStore();
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <h1 className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 font-normal">Hobby Tracker</h1>
      </div>
