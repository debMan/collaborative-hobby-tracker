...
export const mockCategories: Category[] = [
  {
    ...
    name: 'Movies',
    icon: '🎬',
    circleId: null, // Personal category
    ownerId: 'user-1',
    itemCount: 2,
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date(),
...
export const mockItems: HobbyItem[] = [
  ...
  },
  {
    ...
    circleIds: ['circle-2'], // Shared with Friends
  },
  {
    id: 'item-7',
    title: 'Parasite (2019)',
